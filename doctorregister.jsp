       ...
       <div class="col-md-4 offset-md-4 admin" >
            ...
            <div class="row">     
                  ...
                  <label for="email">Specialization</label>
                     <input type="text" class="form-control" id="specialization" aria-describedby="emailHelp" name="age" placeholder="Enter specialization..." required>
              ...
              <div class="row">   
               ...
               <div class="row">   
                 <div class="form-group">
                     ...
                     <input type="date" class="form-control" id="rdate" aria-describedby="emailHelp" name="registerdate" value="date"  required>
                 </div>
               </div>    
